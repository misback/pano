...
class PanoramaCameraRender:public TaskMessage, public AudioInterface{
    public:
        PanoramaCameraRender(const char* mediaDir, jobject panorama_callback_obj, jmethodID cbScreenShotMethod, jmethodID callbackSaveFilterMethod);
        PanoramaCameraRender& operator=(const PanoramaCameraRender& ) = delete;
        PanoramaCameraRender(PanoramaCameraRender&) = delete;
        virtual ~PanoramaCameraRender();
    private:
        int                         _videoWidth;
        int                         _videoHeight;
        int                         _widgetWidth;
        ...
        GLuint                      _uCameraTextureLocPlay1;
        GLuint                      _uCameraTextureLocPlay2;
    ...
    public:
        ...
        GLint nativeGetTextureId1();
        GLint nativeGetTextureId2();
