...
void FanChart::init(int perVertex, float radius, float latitude, float longitude){
    ...
    double hemisphere       =      longitude / (float) _perVertex;
    double sphere           =      2 * latitude / (float) _perVertex;
