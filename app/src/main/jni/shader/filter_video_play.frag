const static char* filter_video_play_frag    =   STRINGIFY(
    ...
    void main(void){
        ...
        if(u_GpuImage == 1){
          ...
          r_Color.r = r_Color.g = r_Color.b = result;
        }else if(u_GpuImage == 2){
          r_Color.r = 0.393*r_Color.r+0.769*r_Color.g+0.189*r_Color.b;
          r_Color.g = 0.349*r_Color.r+0.686*r_Color.g+0.168*r_Color.b;
          r_Color.b = 0.272*r_Color.r+0.534*r_Color.g+0.131*r_Color.b;
        }
