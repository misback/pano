...
#define LOGI(...) ((void)__android_log_print(ANDROID_LOG_INFO, "VideoInjector", __VA_ARGS__))
#define LOGW(...) ((void)__android_log_print(ANDROID_LOG_WARN, "VideoInjector", __VA_ARGS__))
#define LOGE(...) ((void)__android_log_print(ANDROID_LOG_ERROR, "VideoInjector", __VA_ARGS__))
