...
LOCAL_SRC_FILES := com_uniunivr_injector_video.cpp spatialmedia/parser.cpp spatialmedia/metadata_utils.cpp spatialmedia/mpeg/mpeg4_container.cpp spatialmedia/mpeg/sa3d.cpp spatialmedia/mpeg/box.cpp spatialmedia/mpeg/container.cpp spatialmedia/mxml-2.10/mxml-attr.c spatialmedia/mxml-2.10/mxml-entity.c spatialmedia/mxml-2.10/mxml-file.c spatialmedia/mxml-2.10/mxml-get.c spatialmedia/mxml-2.10/mxml-index.c spatialmedia/mxml-2.10/mxml-node.c spatialmedia/mxml-2.10/mxml-private.c spatialmedia/mxml-2.10/mxml-search.c spatialmedia/mxml-2.10/mxml-set.c spatialmedia/mxml-2.10/mxml-string.c
